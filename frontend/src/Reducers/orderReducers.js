...
export const orderPayPendingReducer = (state = {}, action) => {
    switch(action.type) {

        case ORDER_PAY_PENDING_REQUEST:
            return {
                loading: true
            }

        case ORDER_PAY_PENDING_SUCCESS:
            return {
                loading: false,
                success: true
            }
        
        case ORDER_PAY_PENDING_FAIL:
            return {
                loading: false,
                error: action.payload
            }
...
export const orderMineReducer = (state = {orders: [], loading: true}, action) => {
    switch(action.type) {
